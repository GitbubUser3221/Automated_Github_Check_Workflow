...
## Report generated at 2026-03-09 14:09:34
...
Repo2Docker build failed.<br> Repo2Docker Output:<br>```text<br>.027           return hook(config_settings)
#20 4.027         File "/tmp/pip-build-env-oxv15by5/overlay/lib/python3.10/site-packages/setuptools/build_meta.py", line 333, in get_requires_for_build_wheel
#20 4.027           return self._get_build_requires(config_settings, requirements=[])
#20 4.027         File "/tmp/pip-build-env-oxv15by5/overlay/lib/python3.10/site-packages/setuptools/build_meta.py", line 301, in _get_build_requires
#20 4.027           self.run_setup()
#20 4.027         File "/tmp/pip-build-env-oxv15by5/overlay/lib/python3.10/site-packages/setuptools/build_meta.py", line 520, in run_setup
#20 4.027           super().run_setup(setup_script=setup_script)
#20 4.027         File "/tmp/pip-build-env-oxv15by5/overlay/lib/python3.10/site-packages/setuptools/build_meta.py", line 317, in run_setup
#20 4.027           exec(code, locals())
#20 4.027         File "<string>", line 19, in <module>
#20 4.027       ModuleNotFoundError: No module named 'pkg_resources'
#20 4.027       [end of output]
#20 4.027   
#20 4.027   note: This error originates from a subprocess, and is likely not a problem with pip.
#20 4.128 error: subprocess-exited-with-error
#20 4.128 
#20 4.128 × Getting requirements to build wheel did not run successfully.
#20 4.128 │ exit code: 1
#20 4.128 ╰─> See above for output.
#20 4.128 
#20 4.128 note: This error originates from a subprocess, and is likely not a problem with pip.
...
4.027       [end of output]
4.027   
4.027   note: This error originates from a subprocess, and is likely not a problem with pip.
4.128 error: subprocess-exited-with-error
4.128 
4.128 × Getting requirements to build wheel did not run successfully.
4.128 │ exit code: 1
4.128 ╰─> See above for output.
4.128 
4.128 note: This error originates from a subprocess, and is likely not a problem with pip.
------
Dockerfile:118
--------------------
...
subprocess.CalledProcessError: Command '['docker', 'buildx', 'build', '--progress', 'plain', '--build-arg', 'NB_USER=runner', '--build-arg', 'NB_UID=1001', '--tag', 'r2dtestee1773065374', '--platform', 'linux/amd64', '/tmp/tmp2ju8ftzm']' returned non-zero exit status 1.
<br>```<br>